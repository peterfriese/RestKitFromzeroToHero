...
- (id)initWithObjectStore:(RKManagedObjectStore *)theObjectStore
{
    ...
    if (self) {
        ...
        //    [[[RKObjectManager sharedManager] mappingProvider] setObjectMapping:issueMapping forResourcePathPattern:@"/repos/:user/:repo/issues" withFetchRequestBlock:^NSFetchRequest *(NSString *resourcePath) {
        //
